...
with tab2:
    ...
    # Settings for noise sensitivity and timeout
    ...
    # Process user input after voice recognition
    # Process user input after voice recognition
if user_input:
    if user_input.lower() == "bye":
        response = "👋 Goodbye! Take care!"
...
if language != "en" and user_input:
    try:
        translated_text = translator.translate(response, src="en", dest=language).text
